...
impl App {
    ...
    pub(super) fn loading_provider_models_state_for_preset(
    ...
    pub(super) fn spawn_provider_model_load(
        &self,
    ...
    pub(super) async fn write_app_server_config_batch(
        &mut self,
    ...
    pub(super) async fn configure_provider_definition_and_load(
        &mut self,
        app_server: &mut AppServerSession,
        preset: ProviderPreset,
